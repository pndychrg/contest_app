...
class _WebsiteBookmarkState extends State<WebsiteBookmark> {
  var userWebsiteList = [];
  //boolean for Checking is the userWebsiteList is Empty
  bool userWebsiteListisEmpty = false;
  ...
  Future _getUserBookmarkList() async {
    ...
    if (userWebsiteList.isEmpty) {
      setState(() {
        userWebsiteListisEmpty = true;
      });
    }
  }
                        ...
                        children: <Widget>[
                          ...
                          OutlinedButton(
                            ...
                            onPressed: () {
                              ...
                              var siteListData = [];
                              user?.websitesList[index].forEach(
                                  (key, value) => siteListData.add(value));
                          ...
                          OutlinedButton(
                            ...
                            onPressed: () async {
                              final url =
                                  user?.websitesList[index]['website_url'];
